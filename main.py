...
def main():
    ...
    model.load_model("salary_predictor.cbm")

    st.title("Salary Predictor")

    
    age = st.number_input("Enter your age", min_value=0, max_value=100, step=1)
    experience = st.number_input("Enter your experience", min_value=0, step=1)
    ...
    if st.button("Submit"):
        pred = model.predict([[age, gender, education,job, experience]])
        st.write(pred)
